...
import com.karthick.mvvm.ui.single_movie_details.SingleMovie
import com.karthick.mvvm.data.vo.Movie
import kotlinx.android.synthetic.main.activity_single_movie.*
import kotlinx.android.synthetic.main.movie_list_item.view.*
import kotlinx.android.synthetic.main.network_state_item.view.*

class PopularMoviePageAdapter(public val context: Context) :
    ...
    class MovieItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie: Movie?, context: Context) {
            ...
            val Bold = Typeface.createFromAsset(context.assets, "Lato-Bold.ttf")
            val Regular = Typeface.createFromAsset(context.assets, "Lato-Regular.ttf")

            itemView.cv_movie_title.text = movie?.title
            itemView.cv_movie_release_date.text = movie?.releaseDate
            itemView.cv_movie_title.typeface = Bold
            itemView.cv_movie_release_date.typeface = Regular
